		...
		self.pages = {
			...
			display = UIPanel(self.x,self.y, self.width,self.height,
				...
				
				{
					...
					UIRangeSlider(0.3,0.16,0.7,0.018, Alias(mainComponent, "lowestKey"),Alias(mainComponent, "highestKey"), 0,255,1),
				...
				
				{
					...
					UISliderSuite(0.0,0.1, 1.0,0.07, "Length Scale", Alias(mainComponent.notesComponent, "noteScale"), 0.01,100, 1),
					
					UISliderSuite(0.0,0.2, 1.0,0.07, "Length Offset", Alias(mainComponent.notesComponent, "noteLengthOffset"), 0,1, 0.0001),
					
					UISliderSuite(0.0,0.3, 1.0,0.07, "Pitch Bend Range", Alias(mainComponent.notesComponent, "pitchBendSemitone"), 0,64, 1),
					...
					UICheckbox(0.0,0.75, 1.0,0.04, "Note Outlines (Warning: may cause lag)", Alias(mainComponent.notesComponent, "noteOutlines")),
				},
				
				{
					UIText(0.0,0.0, 1.0,0.05, "Falls", 1, true,true),
					
					UISliderSuite(0.0,0.1, 1.0,0.07, "Length Scale", Alias(mainComponent.fallsComponent, "noteScale"), 0,100, 0.0001),
				...
				
				{
					...
					UISliderSuite(0.0,0.1, 1.0,0.07, "Length Scale", Alias(mainComponent.hitAnimationComponent, "lengthScale"), 0,100, 0.0001),
